...
При создании или редактировании турнира теперь можно выбрать уровень участников (Новичок, Любитель или Про) и добавить фотографию для превью, которая будет отображаться в списках турниров.
